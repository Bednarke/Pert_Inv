...
local_data_path = 'C:\Pert_Inv\Local_mne_data\small_imbalance\side%s' % (sign,)  # 'C:\Pert_Inv\Local_mne_data\side%s' % (sign,)
    ...
    for k in range(0, max_imbalance + 1):
        ...
        for i in range(0, max_rad):
            for j in range(0, 3):
                ...
                data[i, 19] = round(dip_fit_pert.pos[i][1], 6)
